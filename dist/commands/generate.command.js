...
var absctract_command_1 = require("./absctract.command");
var schematics_1 = require("../lib/schematics");
var GenerateCommand = /** @class */ (function (_super) {
    ...
    GenerateCommand.prototype.load = function (program) {
        ...
        program
            ...
            .action(function (schematic, name, path, option, Command) { return __awaiter(_this, void 0, void 0, function () {
            var inputs;
    ...
    GenerateCommand.prototype.buildDescription = function () {
        return ('Generate a new element.\n' +
    ...
    GenerateCommand.prototype.buildSchematicsListAsTable = function () {
        ...
        for (var _i = 0, schematics_2 = schematics_1.schematics; _i < schematics_2.length; _i++) {
            var schematic = schematics_2[_i];
            table.push([
...
}(absctract_command_1.AbstractCommand));
